...
---
#### 研究目的:因為這幾年空氣品質很差，網路上就有人說是因為大陸的髒空氣吹過來的，於是我就蒐集的各縣市的[PM2.5]和[風向]來做比較，看看會不會在吹某個風向的時候空氣品質最差!

###### 資料來源 [空氣品質監測網](https://taqm.epa.gov.tw/taqm/tw/YearlyDataDownload.aspx),[觀測資料查詢](https://e-service.cwb.gov.tw/HistoryDataQuery/index.jsp)
...
#### 結論:一開始用了散佈圖來觀察，發現[空氣差]和[風向]沒有直接關係，於是又畫了直條圖來觀察各縣市的空氣品質，發現其實東北部反而比西南部空氣差!?
###### 其實一開始有抓了每個縣市的DATA，但是再轉HTML時轉不出來，發生了(maximum recursion depth reached.),結果後來程式重灌就可以了... 
