...
data1 <- c()
links <- character()
front <- "https://news.ltn.com.tw/search/?keyword=%E9%A2%B1%E9%A2%A8%20%E5%BD%B1%E9%9F%BF%20%E5%9C%B0%E5%8D%80&conditions=and&SYear=2017&SMonth=7&SDay=1&EYear=2017&EMonth=9&EDay=30&page="
for (i in 1:33) { #------------------------------------------------------------------------改頁數
...
for (i in 2:107)#------------------------------------------------------------------------看d.corpus的elements有幾個
{
